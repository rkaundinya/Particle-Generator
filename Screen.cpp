...
// Finds color values in box around current pixel and finds
// average color of all surrounding pixels setting that to current pixel
void Screen::boxBlur()
{
    // Swap the buffers so pixel info is in m_buffer2
    // and we're drawing to m_buffer1
    ...
    for ( int y = 0; y < SCREEN_HEIGHT; ++y )
    {
        for ( int x = 0; x < SCREEN_WIDTH; ++x )
        {
            ...
            // Go through surrouding box of pixels one by one
